      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Research Officer Name <span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Pak number<span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Lab<span class="text-danger">*</span></label>
              <div class="col-md-8">
